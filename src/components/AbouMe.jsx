...
import myPicture from '../assets/images/ana.png';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faJava, faReact, faJs, faBootstrap, faPhp, faGit, faGithub } from '@fortawesome/free-brands-svg-icons';
import { faFeatherAlt, faLeaf } from '@fortawesome/free-solid-svg-icons'; 

const AboutMe = () => {
  return (
    <section   id="about" className="flex flex-col md:flex-row items-center p-8 bg-gray-900 text-white space-y-6 md:space-y-0 md:space-x-8 relative">
      ...
      <div className="md:w-2/3 w-full space-y-4">
        ...
        <div className="flex flex-wrap space-x-4 mt-4">
          ...
          <FontAwesomeIcon icon={faFeatherAlt} className="text-3xl text-blue-500" title="Tailwind CSS" />
          ...
          <img src="https://laravel.com/img/logomark.min.svg" alt="Laravel" className="w-8 h-8" title="Laravel" /> 
          <FontAwesomeIcon icon={faLeaf} className="text-3xl text-green-600" title="Spring Boot" /> 
